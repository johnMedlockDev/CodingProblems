namespace CodingProblems.Console.Tests;
...
public class EasyTests
{
    ...
    [TestMethod()]
    public void ToThePowerOf_GivenAB_ExpectPower_1()
    {
        var givenA = 5;
        var givenB = 5;
        var expected = 3125;
    ...
    [TestMethod()]
    public void ToThePowerOf_GivenAB_ExpectPower_2()
    {
        var givenA = 10;
        var givenB = 10;
    ...
    [TestMethod()]
    public void ToThePowerOf_GivenAB_ExpectPower_3()
    {
        var givenA = 3;
        var givenB = 3;
        var expected = 27;
    ...
    [TestMethod()]
    public void MultiplyByLength_GivenIntArray_ExpectIntArrayWithValuesMultipledByLengthOfArray_1()
    {
    ...
    [TestMethod()]
    public void MultiplyByLength_GivenIntArray_ExpectIntArrayWithValuesMultipledByLengthOfArray_2()
    {
    ...
    [TestMethod()]
    public void MultiplyByLength_GivenIntArray_ExpectIntArrayWithValuesMultipledByLengthOfArray_3()
    {
    ...
    [TestMethod()]
    public void MultiplyByLength_GivenIntArray_ExpectIntArrayWithValuesMultipledByLengthOfArray_4()
    {
    ...
    [TestMethod()]
    public void HammingDistance_GivenTwoDiffrentWords_ExpectNumberofDiffrentLetters_1()
    {
        var givenA = "abcde";
        var givenB = "bcdef";
        var expected = 5;
    ...
    [TestMethod()]
    public void HammingDistance_GivenTwoDiffrentWords_ExpectNumberofDiffrentLetters_2()
    {
        var givenA = "strong";
        var givenB = "strung";
        var expected = 1;
    ...
    [TestMethod()]
    public void HammingDistance_GivenTwoOfTheSameWord_ExpectNumberofDiffrentLettersToBeZero()
    {
        var givenA = "abcde";
        var givenB = "abcde";
        var expected = 0;
